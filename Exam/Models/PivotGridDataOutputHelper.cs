...
namespace Exam.Models
{
    public class PivotGridDataOutputDemosHelper
    {
        ...
        public static PivotGridSettings GetPivotGridExportSettings(PivotGridExportWYSIWYGDemoOptions options)
        {
            ...
            exportSettings.SettingsExport.OptionsPrint.PrintColumnFieldValues = options.PrintColumnAreaOnEveryPage;
            exportSettings.SettingsExport.OptionsPrint.PrintRowFieldValues = options.PrintRowAreaOnEveryPage;
